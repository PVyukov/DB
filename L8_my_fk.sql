...
ALTER TABLE profiles 
  ADD CONSTRAINT profiles_usder_id_fk
      FOREIGN KEY (user_id)
      REFERENCES users(id) 
      ON DELETE CASCADE
      ON UPDATE CASCADE;

ALTER TABLE friendship CHANGE status_id status_id INT UNSIGNED;
...
ALTER TABLE friendship
      ...
      ADD CONSTRAINT friendship_friend_id_fk
        ...
        ON DELETE CASCADE
        ON UPDATE CASCADE,
      ADD CONSTRAINT frinrdship_status_id
 ...
 ALTER TABLE communities_users
       ADD CONSTRAINT comminities_users_user_id_fk
         FOREIGN KEY (user_id)
         REFERENCES users(id)
         ON DELETE CASCADE
         ON UPDATE CASCADE,
